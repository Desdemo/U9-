...
copy .\bin\Debug\UFIDA.U9.Cust.BLT.FeeRecordUI.WebPart.dll  C:\yonyou\U9V60\Portal\UILib
copy .\bin\Debug\UFIDA.U9.Cust.BLT.FeeRecordUI.WebPart.pdb  C:\yonyou\U9V60\Portal\UILib

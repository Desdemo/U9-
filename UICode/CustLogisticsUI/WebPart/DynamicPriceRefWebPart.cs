...
/***********************************************************************************************
 * Form ID:4f63643c-eaa3-47d5-814f-a2ab498e13f0 
 * Form Name:DynamicPriceRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace DynamicPriceRef
{
	[FormRegister("UFIDA.U9.Cust.BLT.CustLogisticsUI","DynamicPriceRef.DynamicPriceRefWebPart", "UFIDA.U9.Cust.BLT.CustLogisticsUI.WebPart", "4f63643c-eaa3-47d5-814f-a2ab498e13f0","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.BLT.CustLogisticsUI', 'DynamicPriceRef.DynamicPriceRefWebPart', 'UFIDA.U9.Cust.BLT.CustLogisticsUI.WebPart', '4f63643c-eaa3-47d5-814f-a2ab498e13f0')
	///<siteMapNode url="~/erp/simple.aspx?lnk=4f63643c-eaa3-47d5-814f-a2ab498e13f0" title="DynamicPriceRef"/>
    public partial class DynamicPriceRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(DynamicPriceRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new DynamicPriceRefAction Action
		{
			get { return (DynamicPriceRefAction)base.Action; }
			set { base.Action = value; }
		}
		DynamicPriceRefModel _uimodel=null;
		public new DynamicPriceRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new DynamicPriceRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as DynamicPriceRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public DynamicPriceRefWebPart()
        {
            FormID = "4f63643c-eaa3-47d5-814f-a2ab498e13f0";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new DynamicPriceRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (DynamicPriceRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new DynamicPriceRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"DynamicPriceRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","bd34f247-81d9-4c17-9b47-68c0e516c718");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","336078bc-cc33-4236-8124-794c5da0ba64");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","83537f58-241b-48e5-9771-c43e69dc35af");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","0d429a84-fc49-49fe-be63-4f0a1fb564bd");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","067d2733-e3a8-4f34-ac1d-24a5deaea70a");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","9d0ca0fe-b665-4da6-ae65-9cf0559dc3ef");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","ed0f83c6-9ff9-49d9-af3a-982e13397e51");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","220d0949-9feb-419f-8746-e1e375182d25");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","48808f8a-9d8f-4650-8d65-d7ecb3a75a8f");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","7fb1ccd9-7445-4c77-88fd-f3230b77fd05");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","c17e9da8-fcbb-4086-bb21-5c2c18293d02");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","df1817cb-2b49-419c-a8b1-fd96c379d2f8");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","48de6493-f5c2-47d5-b161-8d8a86b4723a");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","3a471e6e-d0ab-43ef-b784-7c49366af4f1");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","e468e3ed-a1d1-4653-bc55-59c4379c7cd9");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			InitViewBindingContainer(this, _UFGrid,  this.Model.cRef, "cRef", "", null, 13, "动态价格");
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "19",true, false,"","fcc5f621-b901-4339-b9d5-3c0c10762869","fcc5f621-b901-4339-b9d5-3c0c10762869","fd0845c0-2ff3-4983-8db4-232a9a0ac12f");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Code0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Code"]/*Code*/,"Code", false, true, true, false, false, true, 0, 80, "5",true, false,"","bbb459c2-5609-49e5-9a51-8f034b636e89","bbb459c2-5609-49e5-9a51-8f034b636e89","394ee498-f896-4c56-b834-e646f9bc43c5");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Name"]/*Name*/,"Name", false, true, true, false, false, true, 0, 80, "5",true, false,"","d8349b7d-ccda-43e5-9a2b-e9555b604395","d8349b7d-ccda-43e5-9a2b-e9555b604395","fb1985b1-37b4-4567-bf56-444cb0e58413");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"EffectField0","DropDownListColumnModel", "", 0,this.Model.cRef.Fields["EffectField"]/*EffectField*/,"EffectField", false, true, true, false, false, true, 2, 80, "5",true, false,"","12cc45de-cf38-46e9-9dc5-28fad091c8ab","12cc45de-cf38-46e9-9dc5-28fad091c8ab","59454ab0-f98f-4d6d-ae33-52e0770783a0");
			((IUFDropDownListColumn)column).EnumTypeID  = "UFIDA.U9.Cust.BLT.CustLogisticsBE.EffectFieldEnum";
			EnumTypeList.Add("UFIDA.U9.Cust.BLT.CustLogisticsBE.EffectFieldEnum");
			EnumControlsMap.Add(column, _UFGrid);
			  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"DynamicPriceType0","DropDownListColumnModel", "", 0,this.Model.cRef.Fields["DynamicPriceType"]/*DynamicPriceType*/,"DynamicPriceType", false, true, true, false, false, true, 2, 80, "5",true, false,"","87b2fa45-8782-4665-8058-be3466a44887","87b2fa45-8782-4665-8058-be3466a44887","13696caf-3572-4780-ab77-82923de54a39");
			((IUFDropDownListColumn)column).EnumTypeID  = "UFIDA.U9.Cust.BLT.CustLogisticsBE.DynamicPriceTypeEnum";
			EnumTypeList.Add("UFIDA.U9.Cust.BLT.CustLogisticsBE.DynamicPriceTypeEnum");
			EnumControlsMap.Add(column, _UFGrid);
			  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Uom_Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Uom_Name"]/*Uom_Name*/,"Uom_Name", false, true, true, false, false, true, 0, 80, "5",true, true,"","ddd5bfbe-be1b-4276-9f26-48fc9f386a31","ddd5bfbe-be1b-4276-9f26-48fc9f386a31","5af00b75-d3be-4fd4-9b97-73253d5629e5");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","787a2a50-e9df-47b4-8619-e87f800ad02e");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","78ea4db2-99b5-499d-a711-e047d7cb9901");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","1b3566fa-d913-409e-9a3a-731cf1e309f5");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","3d3b5441-f568-466e-95df-897eca1479a8");
            _UFListControl.Items.Add(listItem);
        }

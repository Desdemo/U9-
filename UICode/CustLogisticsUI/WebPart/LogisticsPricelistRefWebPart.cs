...
/***********************************************************************************************
 * Form ID:436d4c5d-73a1-4b9b-8498-fd86e4d3ddff 
 * Form Name:LogisticsPricelistRef
 * UIFactory Auto Generator
 ***********************************************************************************************/
namespace LogisticsPricelistRef
{
	[FormRegister("UFIDA.U9.Cust.BLT.CustLogisticsUI","LogisticsPricelistRef.LogisticsPricelistRefWebPart", "UFIDA.U9.Cust.BLT.CustLogisticsUI.WebPart", "436d4c5d-73a1-4b9b-8498-fd86e4d3ddff","WebPart", "False", 580, 408)] 
	///insert into aspnet_Parts (SysVersion, Path, ClassName, [Assembly], FormId) values (0, 'UFIDA.U9.Cust.BLT.CustLogisticsUI', 'LogisticsPricelistRef.LogisticsPricelistRefWebPart', 'UFIDA.U9.Cust.BLT.CustLogisticsUI.WebPart', '436d4c5d-73a1-4b9b-8498-fd86e4d3ddff')
	///<siteMapNode url="~/erp/simple.aspx?lnk=436d4c5d-73a1-4b9b-8498-fd86e4d3ddff" title="LogisticsPricelistRef"/>
    public partial class LogisticsPricelistRefWebPart : UFSoft.UBF.UI.FormProcess.BaseWebForm
    {
		#region Page Controller/Code Behind
        private static readonly ILogger logger = LoggerManager.GetLogger(typeof(LogisticsPricelistRefWebPart));
        private string assemblyName = System.Reflection.Assembly.GetExecutingAssembly().FullName;
        //private string displayNamePostfix = "displayName";

		#region 强类型化基类属性.
		public new LogisticsPricelistRefAction Action
		{
			get { return (LogisticsPricelistRefAction)base.Action; }
			set { base.Action = value; }
		}
		LogisticsPricelistRefModel _uimodel=null;
		public new LogisticsPricelistRefModel Model
		{
			get 
			{
			     if(_uimodel == null){
			          _uimodel = new LogisticsPricelistRefModel();
			     }
			     return _uimodel; 
			}
			set { _uimodel = value; }
        ...
        protected override IUIModel UIModel{
            ...
            set{
                this.Model = value as LogisticsPricelistRefModel;
            }
        }
		#endregion 
        ...
        #region constructor
        public LogisticsPricelistRefWebPart()
        {
            FormID = "436d4c5d-73a1-4b9b-8498-fd86e4d3ddff";
	...
	//获取档案版型结果: 
		...
		protected override void OnLoadDataDo(EventArgs e)
		{
			...
			{
				if(this.Model==null){				        
					this.Model = new LogisticsPricelistRefModel();
				}
			...
			else
			{
				...
				//去除.已经移入到OnInit()中.
				//this.Model = (LogisticsPricelistRefModel)this.CurrentState[this.TaskId.ToString()];
			}
		...
		{			 
            ...
            this.Action = new LogisticsPricelistRefAction(this);
        ...
        {
            IUFContainer _panel = UIControlBuilder.BuildTopLevelContainer(this,"LogisticsPricelistRef",true,580,408);
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card4",false,"none", true, true, "1","","de4523c1-c79e-490c-89c3-c37ff7b80491");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.Label0 = UIControlBuilder.BuilderUFLabel(_UFCard, "Label0", "", "True", "True", "Right", 45, 20, 0, 0, 1, 1, "100","9bf97f14-74b9-4a4f-b2fc-d5bfb9c95e3a","6aef1b9f-bf19-4096-94aa-26767d59ca72");
			...
			UIControlBuilder.BuilderUFControl(this.Label0, "0");		
		        ...
		        this.SelectList = UIControlBuilder.BuilderDropDownList(_UFCard, "SelectList", "", true,  true, true, "Left", 0, 60, 0, 120, 20, 2, 0, 1, 1, "100",true,false,"","","9a789cc5-e028-46ba-9609-4b4ebee9476c");
			...
			UIControlBuilder.BuilderUFControl(this.WizardControl0, "2");		
				...
				this.lblContinueCheckBox = UIControlBuilder.BuilderUFLabel(_UFCard, "lblContinueCheckBox", "", "False", "True", "Right", 80, 20, 6, 0, 1, 1, "100","0aead14b-b05a-4582-9aca-34da4f4bf7a0","d3b2c54e-a295-47e6-a9cd-44505911d4ad");
			...
			UIControlBuilder.BuilderUFControl(this.lblContinueCheckBox, "3");		
				...
				this.ContinueCheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "ContinueCheckBox", false, true, "Left", 60, 0, 30, 20, 8, 0, 1, 1, "100",true,"lblContinueCheckBox","","9232fd21-5711-42ac-a3ba-810667b77720");
			...
			UIControlBuilder.BuilderUFControl(this.ContinueCheckBox, "4");		
				...
				this.FindButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "FindButton", true, true, 60, 20, 10, 0, 1, 1, "100","R", this.Model.ElementID,"",false,"27621430-7bc7-4c0e-979e-f0108439d13e","27621430-7bc7-4c0e-979e-f0108439d13e","76ddc0b4-4831-4623-868f-2e281fd8df37");
			...
			UIControlBuilder.BuilderUFControl(this.FindButton, "4");		
				...
				this.CheckBox = UIControlBuilder.BuilderUFCheckbox(_UFCard, "CheckBox", false, true, "Left", 60, 0, 30, 20, 0, 0, 1, 1, "100",false,"","","4d0d8f6a-b628-4dd5-8d73-0e9a113387a2");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card6",false,"FunctionBar", true, true, "0","","7a6d6e96-ccbe-414d-aabc-c96e20dbb61f");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"CardForRefQueryCase",false,"none", true, true, "0","","9acddf74-59af-4422-b8c6-f0d4ab197989");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.QryButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "QryButton", true, true, 80, 20, 0, 0, 1, 1, "100","", this.Model.ElementID,"",false,"3664768b-36ca-44ab-9583-8d85fb432e43","3664768b-36ca-44ab-9583-8d85fb432e43","5ae0f963-ce4b-489d-8e20-867fb1590c70");
			...
			UIControlBuilder.BuilderUFControl(this.QryButton, "1");		
				...
				this.lbCase = UIControlBuilder.BuilderUFLabel(_UFCard, "lbCase", "", "True", "True", "Right", 80, 20, 3, 0, 1, 1, "100","7fb97e0d-d794-43d8-9b10-4ea28a2d6bd3","2e812ab5-a9fa-4c57-abfe-58c318278899");
			...
			UIControlBuilder.BuilderUFControl(this.lbCase, "1");		
		        ...
		        this.DDLCase = UIControlBuilder.BuilderDropDownList(_UFCard, "DDLCase", "", true,  true, true, "Left", 0, 60, 0, 150, 20, 5, 0, 1, 1, "100",true,false,"","","69aaa134-5bef-4c12-923c-465e9c1e98e8");
        ...
        {
            IUFCard _UFCard = UIControlBuilder.BuildCard(container,"Card1",false,"none", true, true, "0","","92e48bd9-a8b5-408e-aa28-092f5f2984b9");
            ...
            ///foreach UFCard下的所有控件，增加到此容器
				...
				this.ConfirmButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "ConfirmButton", true, true, 80, 20, 0, 0, 1, 1, "100","O", this.Model.ElementID,"",false,"626ebf9b-f65a-4dd5-8f32-96f84919878c","626ebf9b-f65a-4dd5-8f32-96f84919878c","d58ebf4e-9eb7-45c1-a371-aaa6ae81c38c");
			...
			UIControlBuilder.BuilderUFControl(this.ConfirmButton, "3");		
				...
				this.CancelButton = UIControlBuilder.BuilderUFButton(_UFCard, true, "CancelButton", true, true, 80, 20, 2, 0, 1, 1, "100","C", this.Model.ElementID,"",false,"020a5365-8f12-4970-b8df-17ce3ae60a68","020a5365-8f12-4970-b8df-17ce3ae60a68","8393ddac-88de-4cfc-a1b5-8bbe6efbdd26");
        ...
        private void _BuilderControl_DataGrid(IUFContainer container)
        {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"ID0","NumberColumnModel", "", 0,this.Model.cRef.Fields["ID"]/*ID*/,"ID", true, false, true, false, false, true, 7, 80, "19",true, false,"","c35bff95-87c7-4d54-9b6c-6d8c59e5a228","c35bff95-87c7-4d54-9b6c-6d8c59e5a228","bfdc3e1c-bce0-43e3-a4a0-8fe403ad2cf6");
    ...
    if (this.UseQueryCase && UFIDA.UBF.Query.CommonService.RefQueryHelper.QueryCaseExist(this.Action, null))
    {
			...
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Code0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Code"]/*Code*/,"Code", false, true, true, false, false, true, 0, 80, "5",true, false,"","02f7e136-41ef-4280-9657-600d4b84268d","02f7e136-41ef-4280-9657-600d4b84268d","be32cdfb-718d-4c97-8322-c57e96781388");
         
			GridControlBuilder.GridTextBoxColumnBuilder((IUFTextBoxColumn)column,"",TextAlign.Left, false,"",false,"1","1","5") ;          
	  
		 	                     
			column = GridControlBuilder.GridColumnBuilder(_UFGrid,"Name0","TextBoxColumnModel", "", 0,this.Model.cRef.Fields["Name"]/*Name*/,"Name", false, true, true, false, false, true, 0, 80, "5",true, false,"","3752e077-2bf8-496b-ac40-2c3fbb0bb9fb","3752e077-2bf8-496b-ac40-2c3fbb0bb9fb","be5f04de-4250-4c7b-89db-40d3291dbaf8");
	        ...
	        private void _BuilderControl_MatchTypeRadioBoxList(IUFContainer container)
        {
            ...
            listItem = UIControlBuilder.BuildListItem(container,"0", true,false,"130bc338-9958-4133-9b7f-9c185bc2455a","b5e7610b-a82b-4c57-8d63-5da7fd827bf3");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"1", true,false,"49790074-95af-497d-ae37-16bb697f3ce6","eeca42fa-f227-436e-8cf4-b4a7dabdfe8e");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"2", true,true,"517d6f15-ca0d-4e3b-aa58-3c85a5b2ae66","61df9b9f-8e87-4232-9c4a-35fd6881f0f4");
            _UFListControl.Items.Add(listItem);
            listItem = UIControlBuilder.BuildListItem(container,"3", true,false,"ea7795fe-8961-4c3f-8ed1-b5128be2cd75","c277fa68-f593-4dea-909f-9f8f9b26994f");
            _UFListControl.Items.Add(listItem);
        }

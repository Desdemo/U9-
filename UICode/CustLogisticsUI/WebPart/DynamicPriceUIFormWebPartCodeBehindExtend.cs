...
{
    public partial class DynamicPriceUIFormWebPart
    {
		...
		private void BtnList_Click_Extend(object sender, EventArgs  e)
		{
			...
			this.Action.CurrentPart.NavigatePage("UFIDA.U9.Cust_BLT_Logistics_DynamicPriceQueryURI",null);
        ...
        {
			//查询按钮设置
			PDFormMessage.ShowConfirmDialog(this.Page, "4f63643c-eaa3-47d5-814f-a2ab498e13f0", "580", "408",

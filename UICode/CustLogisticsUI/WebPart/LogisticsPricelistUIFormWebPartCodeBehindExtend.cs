...
{
    public partial class LogisticsPricelistUIFormWebPart
    {
		...
		private void BtnList_Click_Extend(object sender, EventArgs  e)
		{
			...
			this.Action.CurrentPart.NavigatePage("UFIDA.U9.Cust_BLT_Logistics_LogisticsPricelistsURI", null);
        ...
        {
			//查询按钮设置
			PDFormMessage.ShowConfirmDialog(this.Page, "436d4c5d-73a1-4b9b-8498-fd86e4d3ddff", "580", "408",
		...
		{
			this.Model.LogisticsPricelist.ClearErrorMessage();

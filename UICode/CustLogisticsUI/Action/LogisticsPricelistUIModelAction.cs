/**************************************************************
 * Description:
 * LogisticsPricelistUIModelAction.cs
 * Product: U9
 * Co.    : UFIDA Group
...
{
	public partial class LogisticsPricelistUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(LogisticsPricelistUIModelAction));
		//强类型化基类Model属性.
		public new LogisticsPricelistUIModelModel CurrentModel 
		{
			get {
				return (LogisticsPricelistUIModelModel)base.CurrentModel;
			}
			set {
		...
		public LogisticsPricelistUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public LogisticsPricelistUIModelAction(LogisticsPricelistUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 

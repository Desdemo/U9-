...
{
	public partial class DynamicPriceUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(DynamicPriceUIModelAction));
		//强类型化基类Model属性.
		public new DynamicPriceUIModelModel CurrentModel 
		{
			get {
				return (DynamicPriceUIModelModel)base.CurrentModel;
			}
			set {
		...
		public DynamicPriceUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public DynamicPriceUIModelAction(DynamicPriceUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 

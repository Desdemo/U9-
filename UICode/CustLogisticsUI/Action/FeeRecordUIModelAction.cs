...
{
	public partial class FeeRecordUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(FeeRecordUIModelAction));
		//强类型化基类Model属性.
		public new FeeRecordUIModelModel CurrentModel 
		{
			get {
				return (FeeRecordUIModelModel)base.CurrentModel;
			}
			set {
		...
		public FeeRecordUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public FeeRecordUIModelAction(FeeRecordUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 

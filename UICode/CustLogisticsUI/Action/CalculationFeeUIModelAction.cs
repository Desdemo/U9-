...
{
	public partial class CalculationFeeUIModelAction : BaseAction
	{
		private static readonly ILogger logger = LoggerManager.GetLogger(typeof(CalculationFeeUIModelAction));
		//强类型化基类Model属性.
		public new CalculationFeeUIModelModel CurrentModel 
		{
			get {
				return (CalculationFeeUIModelModel)base.CurrentModel;
			}
			set {
		...
		public CalculationFeeUIModelAction(IPart part) : base(part)
		{
		}
		//Model参数的构造,用于测试用例.
		public CalculationFeeUIModelAction(CalculationFeeUIModelModel model) : base(model)
		{
		}
		/// <summary>
		/// Help: 
		...
		/// Help: 
		/// </summary>
		public void Query(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.Query_Extend);
		}
		private void Query_DefaultImpl(object sender, UIActionEventArgs e)
		{
		...
		/// Help: 
		/// </summary>
		public void Complex(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.Complex_Extend);
		}
		private void Complex_DefaultImpl(object sender, UIActionEventArgs e)
		{
		...
		/// Help: 
		/// </summary>
		public void ManualCostsharing(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.ManualCostsharing_Extend);
		}
		private void ManualCostsharing_DefaultImpl(object sender, UIActionEventArgs e)
		{
		...
		/// Help: 
		/// </summary>
		public void Costsharing(object sender, UIActionEventArgs e)
		{
			//调用基类委托..
			this.InvokeAction(sender,e,this.Costsharing_Extend);
		}
		private void Costsharing_DefaultImpl(object sender, UIActionEventArgs e)
		{
